    ...
    public function searchAction(Request $request) {
        ...
        foreach ($articles as $article) {
            ...
            foreach ($variants as $variant) {
                ...
                $result[] = array('shortName' => $article->getShortName() . "" . $attribute, 'articleNumber' => $variant->getSupplierArticleNumber(), 'price' => $price, 'category' => $category, 'image' => $article->getImage()[0]->getPicName());
                }
            }
        }
